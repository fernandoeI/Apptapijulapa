...
export default function AddPlaceForm(props) {
  const { toastRef, setIsLoading, navigation, setIsReloadPlace } = props;
  ...
  const addPlace = () => {
    if (!placeName || !placeSchedule || !placeDescription || !placeAddress) {
  ...
  return (
    <View style={styles.viewForm}>
      ...
      <Input
        ...
        multiline={true}
        inputContainerStyle={styles.textArea}
        onChange={e => setPlaceSchedule(e.nativeEvent.text)}
      />
