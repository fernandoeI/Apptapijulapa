...
export default function AddExperienceForm(props) {
  const { toastRef, setIsLoading, navigation, id } = props;
  ...
  useEffect(() => {
    db.collection("users")
      ...
      .then((response) => {
        ...
        data.id = response.id;
        setExperience(data);
        setExperienceArea(data.area);
        setDateOpen(data.open);
        setDateClose(data.close);
      });
  }, []);
  ...
  return (
    <View style={styles.viewForm}>
      ...
      <Input
        ...
        inputContainerStyle={styles.input}
        defaultValue={experience.facebook}
      ...
      <Input
        ...
        inputContainerStyle={styles.input}
        defaultValue={experience.whatsapp}
      ...
      <Input
        ...
        inputContainerStyle={styles.input}
        defaultValue={experience.instagram}
