...
import ListExperiences from "../../components/others/ListExperiences";
...
export default function AllExperiences(props) {
  ...
  useEffect(() => {
    if (search) {
      fireSQL
        .query(
          `SELECT * FROM users WHERE giro="other" AND name LIKE '${search}%' OR area LIKE '${search}%'   `
        )
        .then((response) => {
    ...
    <View style={styles.view}>
      <View style={styles.groupRow}>
        ...
        <View style={styles.ellipseStack}>
          ...
          <Image
            source={require("../../../assets/images/otros.png")}
            resizeMode="contain"
            style={styles.image}
          ></Image>
        </View>
      ...
      <View style={styles.todosLosHotelesRow}>
        <Text style={styles.todosLosHoteles}>Todos</Text>
      </View>
