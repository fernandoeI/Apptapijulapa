...
import ListReview from "../../components/experiences/ListReview";
    ...
    <View style={styles.container}>
      ...
      <View style={{ height: heightScreen * 0.6, backgroundColor: "#f2f2f2" }}>
        ...
        >
          ...
          <ListReview navigation={navigation} idExperience={experience.id} />
...
function ExperiencePresentation(props) {
  ...
  return (
    <View style={styles.rectStack}>
      ...
      <Text style={styles.lugares}>EXPERIENCIAS</Text>
